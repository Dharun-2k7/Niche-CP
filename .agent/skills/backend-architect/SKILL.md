...
description: Backend architecture intelligence. System design, database, security, scaling patterns.
---
# backend-architect

Comprehensive backend architecture guide for building scalable, secure, and maintainable systems. Contains architecture patterns, database strategies, security best practices, API design patterns, scaling solutions, and stack-specific guidelines.
...
```bash
python3 skills/backend-architect/scripts/search.py "<keywords>" --domain <domain>
```
...
python3 skills/backend-architect/scripts/search.py "microservices ecommerce" --domain architecture

# Database recommendations for high-traffic system
python3 skills/backend-architect/scripts/search.py "high traffic read-heavy" --domain database

# Security patterns for fintech
python3 skills/backend-architect/scripts/search.py "fintech authentication" --domain security
```
...
```bash
python3 skills/backend-architect/scripts/search.py "<keyword>" --stack <stack>
```
...
python3 skills/backend-architect/scripts/search.py "microservices api" --stack node

# Go concurrency patterns
python3 skills/backend-architect/scripts/search.py "concurrency patterns" --stack go

# Python async patterns
python3 skills/backend-architect/scripts/search.py "async api" --stack python
```
...
python3 skills/backend-architect/scripts/search.py "ecommerce microservices" --domain architecture

# Get database recommendations
python3 skills/backend-architect/scripts/search.py "ecommerce high-traffic" --domain database

# Get caching strategies
python3 skills/backend-architect/scripts/search.py "high-traffic caching" --domain caching
```

### Step 3: Stack Guidelines

```bash
python3 skills/backend-architect/scripts/search.py "api microservices" --stack node
```
