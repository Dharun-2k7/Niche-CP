...
func main() {
	...
	admin.Use(middleware.RequireAdmin())
	{
		...
		// Problem Setter Pipeline Routes
		...
		admin.POST("/problems/:id/testcases", api.CreateManualTestcase)
		admin.GET("/problems/:id/testcases", api.ListTestcases)
		admin.PUT("/problems/:id/testcases/:tid", api.UpdateTestcase)
		admin.DELETE("/problems/:id/testcases/:tid", api.DeleteTestcase)
		admin.POST("/problems/:id/review", api.ReviewProblem)
		admin.POST("/problems/:id/publish", api.PublishProblem)
